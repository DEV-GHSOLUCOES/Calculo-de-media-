...
public class Aluno extends Pessoa {
	...
	private String dataMatriculado;
  ...
  /*construtor com mais de um parametro*/
	...
	public String getDataMatriculado() {
		return dataMatriculado;
	}

	public void setDataMatriculado(String dataMatriculado) {
	...
	public String toString() {
		return "Aluno [nome=" + nome + ", idade=" + idade + ", dataNascimento=" + dataNascimento + ", registroGeral="
				...
				+ ", dataMatriculado=" + dataMatriculado + ", nomeEscola=" + nomeEscola + ", serieMatriculado="
